            ...
            if(adapter.getCurrentSelect()==-1){
                ...
                if(customer_id!=-1) {
                    ...
                    new Handler().postDelayed(() -> {
                        ...
                        HistoryBuy historyBuy = HistoryBuy.getInstance();
                        ...
                        if(isAdmin){
                            ...
                            Toast.makeText(NapTienActivity.this, "Recharge successful", Toast.LENGTH_SHORT).show();

                        }else{
                            historyBuy.setStatus(MyApplication.NAPTIEN_CHOXACNHAN);
                            Toast.makeText(NapTienActivity.this, "Waiting for confirmation", Toast.LENGTH_SHORT).show();
                        }
