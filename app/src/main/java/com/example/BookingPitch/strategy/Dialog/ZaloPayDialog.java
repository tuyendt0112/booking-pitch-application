...
public class ZaloPayDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog( Bundle savedInstanceState) {
        ...
        View view= inflater.inflate(R.layout.dialog_payment_zalopay,null);
        ...
        edtPhone = view.findViewById(R.id.edt_phone_dialog_payment_zalopay);
        edtDesc = view.findViewById(R.id.edt_desc_dialog_payment_zalopay);
        edtAmount = view.findViewById(R.id.edt_amount_dialog_payment_zalopay);
        btnPay = view.findViewById(R.id.btn_pay_zalopay);
        tvCheckPhone = view.findViewById(R.id.tv_check_phone_dialog_payment_zalopay);
