...
import com.example.BookingPitch.facade.*;
...
public class SignupFragment extends Fragment {
    ...
    public void signUp(){
        ...
        CheckCustomerAddingFacade SignUpFacade = new CheckCustomerAddingFacade(phone,name,address,pass,pass2);
        if (!SignUpFacade.AddingCustomerFacade())
        {
