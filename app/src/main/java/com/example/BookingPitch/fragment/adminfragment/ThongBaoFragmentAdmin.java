...
import com.example.BookingPitch.adapter.admin.NotificationAdapter;
        ...
        btn.setOnClickListener(v->{
            if(!edtTitle.getText().toString().equals("") && !edtContent.getText().toString().equals("")){
                ...
                while (cursor.moveToNext()){
                    ...
                    NotificationDetails details = NotificationDetails.getInstance();
                ...
                Toast.makeText(getContext(), "Adding Successful", Toast.LENGTH_SHORT).show();
                dialog.dismiss();
            }
        });
